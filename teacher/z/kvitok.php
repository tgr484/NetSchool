...
$kvitok='Уважаемый '. $nam . ' ' . $ot . ', направляем Вам квитанцию на оплату образовательных услуг по программе повышения квалификации Организация и поддержка образовательного процесса в школе на основе использования системы программ «1С:Образование 5. Школа».
...
<body>
<a href="http://school.bashkortostan.ru/teacher/z/toprint.php?fam='.urlencode($fam).'&name='.urlencode($nam).'&ot='.urlencode($ot).'" style="display:inline-block;white-space:nowrap;font-weight:normal;font-size:18px;line-height:40px;padding:0;min-height:30px;width:160px;text-align:center;color:#fff;border:3px solid;border-radius:10px;text-decoration:none;background-color:#98c593" target="_blank">Квитанция</a><p>Это письмо направлено Вам, так как вы заполнили форму регистрации на сайте.
</body>
</html>
