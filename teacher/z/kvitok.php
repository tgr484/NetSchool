...
';
    $kvitok .= '<b>После оплаты на указанную вами электронную почту придут инструкции по дальнейшей работе, а также данные для авторизации в системе дистанционного обучения.'
            . '<p>Не отвечайте на это письмо!</b>'
            . '<p>Если у Вас остались вопросы, свяжитесь с нами по указанным ниже контактным данным.

<p>С уважением,
<p><b>Центр электронного образования ГАУ ДПО ИРО РБ
<p>cdo.irorb@yandex.ru</b>
<p>г.Уфа, ул. Мингажева, 120, каб.223
<p>тел. 
<p>
<p>
<p>Это письмо направлено Вам, так как вы заполнили форму регистрации на сайте <a href=\"school.bashkortostan.ru\" >school.bashkortostan.ru</a>';
