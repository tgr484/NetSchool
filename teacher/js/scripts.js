...
$(document).ready(function() {
	...
	$('#div_video').videoBG({
		mp4:'assets/videosite2.mp4',
		ogv:'assets/.ogv',
		webm:'assets/videosite2.webm',
		poster:'assets/.jpg',
		scale:true,
		zIndex:0
	});
	$('#div_video_iro').videoBG({
		mp4:'assets/videosite.mp4',
		ogv:'assets/.ogv',
		webm:'assets/videosite.webm',
		poster:'assets/.jpg',
		scale:true,
		zIndex:0
	});
	//document.getElementById('header').style.height = document.getElementById('div_video').style.height;
});
...
$(window).resize(function () {
	...
	document.getElementsByClassName('videoBG_wrapper')[0].style.width = browserWidth + 'px';
	document.getElementsByClassName('videoBG')[0].style.width = browserWidth + 'px';
	//alert(document.getElementsByClassName('videoBG_wrapper')[0].style.width);
